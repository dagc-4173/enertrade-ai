...
export function createForecastRouter(service = forecastSupply, metrics = getForecastMetrics, demand = forecastDemand, demandMetrics = getDemandForecastMetrics, price = forecastPrice) {
  const router = Router();
