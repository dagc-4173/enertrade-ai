...
export function createForecastRouter(service = forecastSupply, metrics = getForecastMetrics, demand = forecastDemand, demandMetrics = getDemandForecastMetrics, price = forecastPrice, trace = priceForecastTrace) {
  const router = Router();
