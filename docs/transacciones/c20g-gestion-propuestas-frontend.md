...
- `CREATED_BY_ME`: permite editar la cantidad y eliminar lógicamente una propuesta pendiente sin aceptaciones; el participante también puede aceptar.
...
- Tras cualquier aceptación, la propuesta creada por la persona deja de mostrar edición y eliminación.
...
Los mensajes de error conservan `serverMessage` cuando el backend lo proporciona. Los mensajes exitosos informan actualización, rechazo, liberación de reserva o confirmación.
...
3. Cuenta A recibe, acepta o rechaza; tras la primera aceptación, Cuenta B no puede editar ni eliminar.
